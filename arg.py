...
def parse_args():
    ...
    parser.add_argument("--save-on-exit", type=lambda x: bool(strtobool(x)), default=True, nargs="?", const=True,
        help="toggle to not save new model on exit")
    parser.add_argument("--save-on-train", type=lambda x: bool(strtobool(x)), default=False, nargs="?", const=True,
        help="toggle to save new model after training")
    parser.add_argument("--has-bias", type=lambda x: bool(strtobool(x)), default=False, nargs="?", const=True,
        help="toggle to add bias to model units")
    # STDP
    parser.add_argument("--stdp-A-plus", type=float, default=1.,
        help="stdp alpha plus coefficient")
    parser.add_argument("--stdp-A-minus", type=float, default=1.,
        help="stdp alpha coefficient")
    parser.add_argument("--stdp-tau-plus", type=float, default=20.,
        help="snn tau plus coefficient")
    parser.add_argument("--stdp-tau-minus", type=float, default=20.,
        help="snn tau minus coefficient")
    parser.add_argument("--stdp-tau-I", type=float, default=16.,
        help="snn tau I coefficient")
    parser.add_argument("--stdp-tau-e", type=float, default=16.,
        help="snn tau synaptic eligibility coefficient")
    parser.add_argument("--stdp-weight-threshold", type=float, default=1.0,
        help="snn weight threshold coefficient")
    # SNN
    ...
    parser.add_argument("--snn-num-steps", type=int, default=1,

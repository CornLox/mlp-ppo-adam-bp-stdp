...
class Writer(SummaryWriter):
    ...
    def final_summary(self, global_step,
        ...
        self.add_scalar("losses/explained_variance",
                        explained_var, global_step)
        print("SPS:", int(global_step / (time.time() - self.start_time)))
        self.add_scalar("charts/SPS", int(global_step /
                        (time.time() - self.start_time)), global_step)

    def test_summary(self, episodic_return):
        self.add_scalar("tests/test_episodic_return", episodic_return)
